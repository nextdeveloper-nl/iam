...
class AbstractAccountUsersPerspectiveService
{
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\IAM\AccountUsersPerspective', $model);
    ...
    public static function update($id, array $data)
    {
        ...
        Events::fire('updating:NextDeveloper\IAM\AccountUsersPerspective', $model);
        ...
        Events::fire('updated:NextDeveloper\IAM\AccountUsersPerspective', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\IAM\AccountUsersPerspective', $model);
