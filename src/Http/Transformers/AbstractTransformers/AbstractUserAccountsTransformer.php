...
class AbstractUserAccountsTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(UserAccounts $model)
    {
    ...
    public function includeSocialMedia(UserAccounts $model)
    {
    ...
    public function includeComments(UserAccounts $model)
    {
    ...
    public function includeVotes(UserAccounts $model)
    {
    ...
    public function includeMeta(UserAccounts $model)
    {
    ...
    public function includePhoneNumbers(UserAccounts $model)
    {
    ...
    public function includeAddresses(UserAccounts $model)
    {
