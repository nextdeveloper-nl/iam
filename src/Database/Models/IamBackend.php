...
use NextDeveloper\IAM\Database\Observers\IamBackendObserver;
 ...
 */
class IamBackend extends Model
{
    ...
    public static function boot()
    {
        ...
        parent::observe(IamBackendObserver::class);
    }
