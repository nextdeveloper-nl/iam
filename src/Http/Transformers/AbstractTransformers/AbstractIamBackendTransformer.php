 ...
 */
class AbstractIamBackendTransformer extends AbstractTransformer {
    ...
    public function transform(IamBackend $model) {
                    ...
                    $iaasVirtualMachineId = \NextDeveloper\\Database\Models\IaasVirtualMachine::where('id', $model->iaas_virtual_machine_id)->first();
