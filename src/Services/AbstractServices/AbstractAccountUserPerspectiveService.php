...
/**
 * This class is responsible from managing the data for AccountUserPerspective
 *
 * Class AccountUserPerspectiveService.
 *
 * @package NextDeveloper\IAM\Database\Models
 */
class AbstractAccountUserPerspectiveService
{
    public static function get(AccountUserPerspectiveQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new AccountUserPerspectiveQueryFilter(new Request());
        }
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\IAM\AccountUserPerspective', $model);
    ...
    public static function update($id, array $data)
    {
        ...
        Events::fire('updated:NextDeveloper\IAM\AccountUserPerspective', $model);
