 ...
 */
class AbstractUserRolesService
{
    public static function get(UserRolesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new UserRolesQueryFilter($request);
        }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?UserRoles
    {
        return UserRoles::findByRef($ref);
    }

    public static function getActions()
    {
        $model = UserRoles::class;
    ...
    {
        $object = UserRoles::where('uuid', $objectId)->first();
     ...
     */
    public static function getById($id) : ?UserRoles
    {
        return UserRoles::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = UserRoles::where('uuid', $uuid)->first();
