...
use NextDeveloper\IAM\Database\Observers\IamAccountUserObserver;
use NextDeveloper\Commons\Database\Traits\UuidId;

/**
 * Class IamAccountUser.
 *
 * @package NextDeveloper\IAM\Database\Models
 */
class IamAccountUser extends Model
{
...
//  We create and add Observer even if we wont use it.
        parent::observe(IamAccountUserObserver::class);
