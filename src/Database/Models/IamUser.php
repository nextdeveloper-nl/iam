...
public function iamAccountUser()
    {
        return $this->hasMany(IamAccountUser::class);
    }

    public function iamLoginLogs()
    {
        return $this->hasMany(IamLoginLog::class);
    }

    public function iamLoginMechanisms()
    {
        return $this->hasMany(IamLoginMechanism::class);
    }
