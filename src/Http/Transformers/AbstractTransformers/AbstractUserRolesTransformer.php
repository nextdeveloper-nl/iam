...
class AbstractUserRolesTransformer extends AbstractTransformer
{
    ...
    public function includeStates(UserRoles $model)
    {
    ...
    public function includeActions(UserRoles $model)
    {
    ...
    public function includeMedia(UserRoles $model)
    {
    ...
    public function includeSocialMedia(UserRoles $model)
    {
    ...
    public function includeComments(UserRoles $model)
    {
    ...
    public function includeVotes(UserRoles $model)
    {
    ...
    public function includeMeta(UserRoles $model)
    {
    ...
    public function includePhoneNumbers(UserRoles $model)
    {
    ...
    public function includeAddresses(UserRoles $model)
    {
