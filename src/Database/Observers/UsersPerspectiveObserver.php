...
class UsersPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAM\UsersPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAM\UsersPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAM\UsersPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAM\UsersPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAM\UsersPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAM\UsersPerspective', $model);
    }
