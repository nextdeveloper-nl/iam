...
class AbstractUserAccountsService
{
    public static function get(UserAccountsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new UserAccountsQueryFilter($request);
        }
    ...
    {
        $object = UserAccounts::where('uuid', $objectId)->first();

        $action = '\\NextDeveloper\\IAM\\Actions\\UserAccounts\\' . Str::studly($action);
    ...
    public static function update($id, array $data)
    {
        ...
        Events::fire('updating:NextDeveloper\IAM\UserAccounts', $model);
