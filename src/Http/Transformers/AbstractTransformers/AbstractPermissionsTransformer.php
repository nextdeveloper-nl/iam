...
class AbstractPermissionsTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(Permissions $model)
    {
    ...
    public function includeSocialMedia(Permissions $model)
    {
    ...
    public function includeComments(Permissions $model)
    {
    ...
    public function includeVotes(Permissions $model)
    {
    ...
    public function includeMeta(Permissions $model)
    {
    ...
    public function includePhoneNumbers(Permissions $model)
    {
    ...
    public function includeAddresses(Permissions $model)
    {
